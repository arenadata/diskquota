...
Change <PATH_TO_DISKQUOTA_SRC> and <PATH_TO_CMAKE_INSTALL_SCRIPT> to the appropriate paths on your local machine, and <IMAGE> to GPDB regression testing image (for example `hub.adsw.io/library/gpdb6_u22:latest` or `hub.adsw.io/library/gpdb7_u22:latest`)
